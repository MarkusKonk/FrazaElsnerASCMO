...
ggplot(mNAOdata, aes(value, fill=variable)) +
  ...
  ylab("Density") + theme(legend.position = c(.8,.9)) +
...
data.INLA$ID.1 = data.INLA$ID.2 = data.INLA$ID.3 = 
  data.INLA$ID.4 = data.INLA$ID.5 = data.INLA$ID
...
formula = DIntDt ~ Int + SST + mei + nao + rmmSum +
  f(ID.1, Int, model="besag", graph=test.nb) +
  f(ID.2, SST, model="besag", graph=test.nb) +
  f(ID.3, mei, model="iid", graph=test.nb) +
  f(ID.4, nao, model="iid", graph=test.nb) +
  f(ID.5, rmmSum, model="iid", graph=test.nb) +
  f(ID, model="besag", graph=test.nb)
...
intPostPlot = ggplot(data=intPost, aes(x=x,y=y, group=1)) +
  ...
  axis.text.y = element_text(size=11), text = element_text(size=11),
  plot.title=element_text(hjust=0)) +
  geom_linerange(x=0, ymin=0, ymax=80, color="red", size=1) +
  geom_linerange(x=-0.0004, ymin=0, ymax = 80, color="gray", size=1)+
  geom_linerange(x=0.0213, ymin=0, ymax = 80, color="gray", size=1)+
  ggtitle('a')
...
sstPostPlot = ggplot(data=sstPost, aes(x=x,y=y, group=1)) +
  ...
  axis.text.y = element_text(size=11), text = element_text(size=11),
  plot.title=element_text(hjust=0)) +
  geom_linerange(x=0, ymin=0, ymax=30, color="red", size=1) +
  geom_linerange(x=0.0523, ymin=0, ymax = 30, color="gray", size=1)+
  geom_linerange(x=0.1103, ymin=0, ymax = 30, color="gray", size=1)+
  ggtitle('b')
...
meiPostPlot = ggplot(data=meiPost, aes(x=x,y=y, group=1)) +
  ...
  plot.title=element_text(hjust=0)) +
  geom_linerange(x=0, ymin=0, ymax=8, color="red", size=1) +
  geom_linerange(x=-0.1042, ymin=0, ymax = 8, color="gray", size=1)+
  geom_linerange(x=0.1157, ymin=0, ymax = 8, color="gray", size=1)+
  ggtitle('a')
...
naoPostPlot = ggplot(data=naoPost, aes(x=x,y=y, group=1)) +
  ...
  axis.text.y = element_text(size=10), text = element_text(size=10),
  plot.title=element_text(hjust=0)) +
  geom_linerange(x=0, ymin=0, ymax=7, color="red", size=1) +
  geom_linerange(x=-0.3004, ymin=0, ymax = 7, color="gray", size=1)+
  geom_linerange(x=-0.0514, ymin=0, ymax = 7, color="gray", size=1)+
  ggtitle('b')
...
mjoPostPlot = ggplot(data=mjoPost, aes(x=x,y=y, group=1)) +
  ...
  axis.text.y = element_text(size=10), text = element_text(size=10),
  plot.title=element_text(hjust=0)) +
  geom_linerange(x=0, ymin=0, ymax=2.5, color="red", size=1) +
  geom_linerange(x=-0.1971, ymin=0, ymax = 2.5, color="gray", size=1)+
  geom_linerange(x=0.5449, ymin=0, ymax = 2.5, color="gray", size=1)+
  ggtitle('c')
